...
<head>
    ...
    <title>Noelgitf</title>
    <style>
        @import url("https://Quathanggiánginhngay24/12/2022");
...
<body>
    ...
    <script>
        var w = c.width = window.innerWidth,
            ...
            opts = {
                strings: ['Chúc Mừng', 'Bạn Nhận Được ', 'Vé Đi Tù'],
                charSize: 100,
                charSpacing: 100,
                lineHeight: 100,
    ...
    <script>
        ...
        function reveal() {
            ...
            ifrm.setAttribute("src", "https://www.youtube.com/watch?v=MYPVQccHhAQ");
